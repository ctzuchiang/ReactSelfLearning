                ...
                <Box display="flex" flexGrow={1}>
                    ...
                    >
                        ...
                        >
                            ...
                            <Typography style={{ color: "#094FA2", fontSize: "38px", WebkitTextStrokeWidth: 0 }}>
                                <b>Genuine, Loyal, Passionate</b>
                            </Typography>
                            <Typography style={{ color: "#094FA2", fontSize: "20px", WebkitTextStrokeWidth: 0 }}>
                                <b>prosperity, leadership, admiration, equality</b>
                            </Typography>
                            <Typography
                                style={{
                                    color: "#094FA2",
                            ...
                            >
                                <b>power, re-education, united, culture,</b>
                            </Typography>
                        </Box>
                        <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center">
                            ...
                            <Typography style={{ color: "#094FA2", fontSize: "38px", WebkitTextStrokeWidth: 0 }}>
                                <b>Acting, Obedient, Passive</b>
                            </Typography>
                            <Typography style={{ color: "#094FA2", fontSize: "20px", WebkitTextStrokeWidth: 0 }}>
                                <b>famine, dictatorship, cult, peripheral</b>
                            </Typography>
                            <Typography
                                style={{
                                    color: "#094FA2",
                            ...
                            >
                                <b>hostile, gulag, sheep, brain-washing</b>
                            </Typography>
                        </Box>
                    </Box>
                </Box>
